...
### Overall UCEIS Accuracy

In addition to per-task metrics, the evaluation calculates:
- **Overall Accuracy**: Percentage of samples where all three tasks are correctly predicted
- **Overall Kappa**: Kappa coefficient for combined multi-task prediction
- **Overall QWK**: Quadratic weighted kappa for combined prediction
